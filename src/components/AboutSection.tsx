...
const AboutSection = () => {
  return (
    <section id="about" className="section-container pt-16 pb-12 md:pt-24 md:pb-16">
      ...
      >
        <h1 className="font-serif text-[1.85rem] md:text-[2.15rem] font-semibold italic text-stone-900 dark:text-stone-100 mb-8 leading-[1.2] tracking-tight" style={{ fontStyle: 'oblique 20deg' }}>
          Hey, I'm Mohammed
        </h1>
