...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="relative py-14 overflow-hidden bg-black">
      ...
      <div className="container mx-auto px-4 sm:px-8 relative z-10">
        ...
        >
          <h2
            className="text-3xl sm:text-5xl font-bold mb-4 sm:mb-6 tracking-tight text-white"
          ...
          <p className="text-white/70 text-base sm:text-lg">
            Have a project in mind or want to discuss a data challenge? I'm
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              style={{
                boxShadow:
                  "0 10px 30px rgba(0, 0, 0, 0.2), 0 0 10px rgba(255, 255, 255, 0.05)",
              }}
                ...
                <div className="space-y-8">
                  <motion.div
                    ...
                    whileHover={{
                      y: -5,
                      boxShadow:
                        "0 10px 30px rgba(0, 0, 0, 0.2), 0 0 15px rgba(255, 255, 255, 0.1)",
                    }}
                  >
                    <div className="w-14 h-14 rounded-full bg-gradient-to-br from-gray-500/30 to-gray-600/30 flex items-center justify-center flex-shrink-0 border border-gray-500/30 shadow-lg shadow-gray-500/10">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="mt-12">
                  ...
                  <div className="flex gap-4">
                    <motion.a
                      ...
                      className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 transition-all duration-300 hover:border-gray-400/30 group"
                      aria-label="LinkedIn"
                      whileHover={{
                        y: -5,
                        boxShadow:
                          "0 10px 20px rgba(0, 0, 0, 0.2), 0 0 15px rgba(255, 255, 255, 0.1)",
                      }}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
